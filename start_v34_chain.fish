...
open(".github/tff-chain-v34-trigger.json","w",encoding="utf-8").write(json.dumps(obj,ensure_ascii=False,indent=2)+"\n")' $start_season $end_year $group_size $wait_minutes $group_timeout_minutes $clean_all

git add .github/tff-chain-v34-trigger.json
git commit -m "Trigger v3.4 safe chain $start_season"
