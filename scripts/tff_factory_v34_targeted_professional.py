#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Balkes TFF Factory v3.4 — targeted safe chain wrapper.

v3.4 keeps the v3.3 targeted senior/professional extraction rules and adds
...
base.FACTORY_VERSION = "v3.4-targeted-safe-chain"
